      ...
      {slides.map((picture, index) => {
        ...
        return (
          <div key={index} className={s.carousel__active}>
            <img src={picture} alt={alt} className={s.carousel__img} />
      ...
      {slides.length ? (
        <>
          <div className={s.carousel__previous} onClick={prevSlide}>
            <img src={arrowBack} alt={alt} className={s.carousel__previous_icon} />
          </div>
          <div className={s.carousel__next} onClick={nextSlide}>
            <img src={arrowForward} alt={alt} className={s.carousel__next_icon} />
          </div>
        </>
      ) : null}
    </div>
